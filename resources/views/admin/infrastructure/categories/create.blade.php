<x-admin-layout>
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-3xl font-bold text-white mb-2">Создание категории инфраструктуры</h1>
            <p class="text-gray-400">Добавьте новую категорию услуг</p>
        </div>
    ...
    <div class="bg-[#0f0f13] border border-white/5 rounded-2xl p-6 max-w-2xl">
        <form method="POST" action="{{ route('admin.infrastructure.categories.store') }}">
            @csrf
