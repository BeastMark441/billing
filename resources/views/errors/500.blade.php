...
@section('title', '500 — Ошибка сервера — NODEUM')

@section('content')
<section class="min-h-[80vh] flex items-center justify-center relative overflow-hidden">
    <!-- Background glow -->
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-red-500/10 rounded-full blur-[120px] -z-10"></div>
    
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div class="mb-8">
            <h1 class="text-[12rem] md:text-[18rem] font-black text-white/5 leading-none select-none">500</h1>
            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full">
                <h2 class="text-3xl md:text-5xl font-bold text-white mb-4">Внутренняя ошибка</h2>
                <p class="text-gray-400 text-lg md:text-xl max-w-xl mx-auto mb-12">
                    Что-то пошло не так на нашей стороне. Мы уже в курсе и работаем над исправлением. Попробуйте обновить страницу позже.
                </p>
