        ...
        <div class="min-h-screen bg-[#0a0a0f]">
            ...
            <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-[#050508] border-r border-white/10 hidden md:flex flex-col transition-transform duration-300">
                ...
                <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
                    ...
                    <div class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2 px-2 mt-4">Финансы</div>

                    <a href="{{ route('admin.finance.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('admin.finance.*') ? 'bg-red-500/10 text-red-500' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
